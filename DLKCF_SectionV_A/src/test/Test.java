...
public class Test {
	...
	public static void main(String[] args) {
		...
		int overlapsec1=10;
		int overlapsec2=10;//Individual local KFs have only one overlapping cells on the boundaries
	    ...
	    for(int i=0;i<Nsecs;i++){
	    	trueSolution[i] = new TriangularTrue(trueSolutionCTM, dt, dx, cellsec, overlapsec, i, Nsecs,1,1,false);//* The last three variables sequentially stand for existence of model parameters perturbation (0 for false and 1 for true), low quality agents (0 for false and 1 for true) and independent agents    
	    }
	    if (Nsecs==1){
	    ...
	    Estimation.exportResult(trueSolutionCTM, trueSolution,trueSolution1,trueSolution2, 2000,"1009overlap");
	}
